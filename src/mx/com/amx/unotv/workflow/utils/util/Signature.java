...
/**
 * Metodo de ooyala para obtener Signature
 * 
 * */
public class Signature {
     ...
     * 
     * */
    public static String generateSignature(String secretKey, String HTTPMethod, String requestPath, HashMap<String, String> parameters, String   requestBody) throws NoSuchAlgorithmException, UnsupportedEncodingException {
